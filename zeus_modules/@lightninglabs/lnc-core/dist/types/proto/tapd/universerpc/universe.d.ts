...
export interface FetchSupplyCommitResponse {
     ...
     */
    blockHeaders: {
        [key: number]: SupplyLeafBlockHeader;
    };
}
...
export interface Universe {
     ...
     */
    ignoreAssetOutPoint(request?: DeepPartial<IgnoreAssetOutPointRequest>): Promise<IgnoreAssetOutPointResponse>;
    /**
     * tapcli: `universe updatesupplycommit`
     * UpdateSupplyCommit updates the on-chain supply commitment for a specific
     * asset group.
     */
    updateSupplyCommit(request?: DeepPartial<UpdateSupplyCommitRequest>): Promise<UpdateSupplyCommitResponse>;
    /**
     * tapcli: `universe fetchsupplycommit`
     * FetchSupplyCommit fetches the on-chain supply commitment for a specific
     * asset group.
     */
    fetchSupplyCommit(request?: DeepPartial<FetchSupplyCommitRequest>): Promise<FetchSupplyCommitResponse>;
    /**
     ...
     */
    fetchSupplyLeaves(request?: DeepPartial<FetchSupplyLeavesRequest>): Promise<FetchSupplyLeavesResponse>;
    /**
     ...
     */
    insertSupplyCommit(request?: DeepPartial<InsertSupplyCommitRequest>): Promise<InsertSupplyCommitResponse>;
}
