...
export interface Mailbox {
     ...
     */
    sendMessage(request?: DeepPartial<SendMessageRequest>): Promise<SendMessageResponse>;
    /**
     ...
     */
    receiveMessages(request?: DeepPartial<ReceiveMessagesRequest>, onMessage?: (msg: ReceiveMessagesResponse) => void, onError?: (err: Error) => void): void;
    /** Returns basic server information. */
    mailboxInfo(request?: DeepPartial<MailboxInfoRequest>): Promise<MailboxInfoResponse>;
}
