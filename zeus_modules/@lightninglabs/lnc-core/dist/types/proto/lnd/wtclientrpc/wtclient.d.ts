...
export interface WatchtowerClient {
     ...
     */
    deactivateTower(request?: DeepPartial<DeactivateTowerRequest>): Promise<DeactivateTowerResponse>;
    /**
     ...
     */
    terminateSession(request?: DeepPartial<TerminateSessionRequest>): Promise<TerminateSessionResponse>;
    /**
...
export {};
//# sourceMappingURL=wtclient.d.ts.map