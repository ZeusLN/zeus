...
describe('Commands', () => {
    ...
    describe('getInitialNotification', () => {
        ...
        it('Android - returns a promise with the initial notification', async () => {
            ...
            const expectedNotification = new NotificationAndroid_1.NotificationAndroid(payload);
            (0, ts_mockito_1.when)(mockedNativeCommandsSender.getInitialNotification()).thenResolve(payload);
        ...
        it('iOS - returns a promise with the initial notification', async () => {
            ...
            const expectedNotification = new NotificationIOS_1.NotificationIOS(payload);
            (0, ts_mockito_1.when)(mockedNativeCommandsSender.getInitialNotification()).thenResolve(payload);
            const result = await uut.getInitialNotification();
            expect(result).toEqual(expectedNotification);
        });
