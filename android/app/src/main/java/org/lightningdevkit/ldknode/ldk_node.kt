...
data class Config (
    ...
    var `paymentRetryTimeoutSecs`: kotlin.ULong
) {
...
public object FfiConverterTypeConfig: FfiConverterRustBuffer<Config> {
    ...
    override fun allocationSize(value: Config) = (
            ...
            FfiConverterULong.allocationSize(value.`paymentRetryTimeoutSecs`)
    )
    ...
    override fun write(value: Config, buf: ByteBuffer) {
            ...
            FfiConverterULong.write(value.`paymentRetryTimeoutSecs`, buf)
    }
}
