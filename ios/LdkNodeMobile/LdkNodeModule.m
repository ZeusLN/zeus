...
RCT_EXTERN_METHOD(setPaymentRetryTimeout:(nonnull NSNumber *)timeoutSeconds resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
