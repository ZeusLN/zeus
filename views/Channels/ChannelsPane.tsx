...
import { Tab as TabComponent } from 'react-native-elements';
import {
    DefaultTheme,
    NavigationContainer,
...
> {
    ...
    render() {
        ...
        const { ChannelsStore, SettingsStore, navigation, NodeInfoStore } =
            this.props;
                        ...
                        {this.state.activeTab == 0 ? (
                            ...
                            >
                                <View style={styles.content}>
                                    {connectingToPeer && <LightningIndicator />}
                                ...
                                <DropdownSetting
                                    title={localeString('general.peer')}
                                    selectedValue={
                                        this.state.channelDestination
                                    }
                                    values={[
                                        {
                                            key: 'Olympus by ZEUS',
