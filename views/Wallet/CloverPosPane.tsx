...
> {
    ...
    fetchProducts = async () => {
        const pos = this.props.SettingsStore?.settings.pos;
        ...
        if (products.size > 0) {
            productsList.push({
                title: localeString('pos.views.Wallet.PosPane.uncategorized'),
                data: [
                    {
                        items: Array.from(products.values()).sort((a, b) =>
    ...
    addProductToOrder = (product: Product) => {
        ...
        order.line_items.push({
            ...
            base_price_money: {
                amount:
                    product.pricedIn === PricedIn.Fiat ? productCalcPrice : 0,
                sats:
