...
> {
    ...
    getSelectionMode = () => {
        return (
            ...
            this.props.route?.params?.selectionMode ||
            false
        );
    };
    ...
    getOnAddressSelected = () => {
        return (
            ...
            this.props.route?.params?.onAddressSelected
        );
    };
    ...
    getShowConfirmButton = () => {
        return (
            ...
            this.props.route?.params?.showConfirmButton ||
            false
        );
    };
    ...
    confirmSelection = () => {
        ...
        const onAddressSelected = this.getOnAddressSelected();
    ...
    render() {
        ...
        if (
            ...
            // Apply search filter if in selection mode
            if (selectionMode && searchText) {
        ...
        return (
            <Screen>
                ...
                {selectionMode && !loadingAddresses && (
                    <SearchBar
