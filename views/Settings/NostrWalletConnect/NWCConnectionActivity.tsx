...
const ConnectionActivityListItem = React.memo(
    ({ item, getRightTitleTheme }: ActivityListItemProps) => {
        let displayName = '';
        let subTitle = '';

        // Determine display name based on activity type
        switch (item.type) {
            case 'pay_invoice':
                displayName =
                    item.status === 'failed'
        ...
        // Determine subtitle based on payment source
