...
import { SpliceOperationType } from '../../models/SpliceOperation';
...
> {
    ...
    renderConfirm = () => {
        ...
        return (
            <View>
                ...
                {dryrunResult.fee != null ? (
                    <>
                        <KeyValue
                            keyValue={localeString(
                                'views.Tools.SpliceOut.onchainFee'
                            )}
                            value={
                                <Amount sats={dryrunResult.fee} toggleable />
                            }
                    ...
                    <WarningMessage
                        message={localeString(
                            'views.Tools.SpliceOut.feeUnknown'
                        )}
                    />
                )}
    ...
    render() {
        const { navigation, SpliceStore } = this.props;
        const { step } = this.state;
        const { loading } = SpliceStore;
        ...
        return (
            <Screen>
                ...
                >
                    {!loading && step === 'input' && this.renderInput()}
